...
isTruthy([]) ;
isTruthy({}) ;
isTruthy(function myFunction() {}) ;
isTruthy("0") ;
isTruthy("Ricardo") ;
isTruthy(true) ;
isTruthy("Curso Javascript Ninja") ;
isTruthy(1 === 1) ;
isTruthy({nome: "Ricardo"}) ;
...
carro.mudarCor("vermelho") ; // undefined --> carro.cor: vermelho 

// E agora, qual a cor do carro?
carro.obterCor() // return é "vermelho"

// Mude a cor do carro para verde musgo.
carro.mudarCor("verde musgo") ; // undefined --> carro.cor: verde musgo 
