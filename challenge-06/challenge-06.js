...
function convertToHex(color) {
    ...
    if (hexadecimalColor.length > 0) {
        result = `O hexadecimal para a cor ${color} é ${hexadecimalColor}` ;    
    } else {
        result = `Não temos o equivalente hexadecimal para ${color}.` ;
    }   
